...
class MemberController extends Controller
{
    public function index()
    {
        ...
        $members = DB::table('members')
                ...
                ->select('members.id', 'classrooms.name as class_name', 'students.name as student_name')
                ->paginate(10);
    ...
    public function create()
    {
        ...
        return view('members.create', compact('students', 'classrooms'));
    }
    ...
    public function edit(member $member)
    {
        ...
        return view('members.edit', compact('member', 'students', 'classrooms'));
    }
